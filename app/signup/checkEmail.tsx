    ...
    return (
        <div className="absolute w-screen h-screen bg-black bg-opacity-60 z-50 grid place-items-center">
            <div className="w-1/3 h-auto p-5 bg-cream rounded-md flex flex-col gap-5 items-center">
                ...
                <button className="w-full p-3 bg-orange rounded-md grid place-items-center shadow-[0px_4px_0px_0px_rgba(238,151,106,1)] hover:shadow-none transition-all duration-300" onClick={() => setShow(false)}>
